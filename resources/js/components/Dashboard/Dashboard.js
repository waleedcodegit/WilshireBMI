                                                ...
                                                <table className="table table-striped">
                                                    <tbody><tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="align-middle">
                                                                ...
                                                                <div className="progress" data-height={6}>
                                                                    <div className="progress-bar bg-success" data-width="50%" />
                                                                </div>
                                                            </td>
                                                            <td>2018-01-20</td>
                                                            <td>2019-05-28</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="text-truncate">
                                                                <ul className="list-unstyled order-list m-b-0 m-b-0">
                                                                    ...
                                                                    <li className="team-member team-member-sm"><img className="rounded-circle" src="assets/img/users/user-2.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                                                            ...
                                                            <td className="align-middle">
                                                                ...
                                                                <div className="progress" data-height={6}>
                                                                    <div className="progress-bar bg-danger" data-width="40%" />
                                                                </div>
                                                            </td>
                                                            <td>2017-07-14</td>
                                                            <td>2018-07-21</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="text-truncate">
                                                                <ul className="list-unstyled order-list m-b-0 m-b-0">
                                                                    ...
                                                                    <li className="team-member team-member-sm"><img className="rounded-circle" src="assets/img/users/user-4.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                                                            ...
                                                            <td className="align-middle">
                                                                ...
                                                                <div className="progress" data-height={6}>
                                                                    <div className="progress-bar bg-purple" data-width="55%" />
                                                                </div>
                                                            </td>
                                                            <td>2019-07-25</td>
                                                            <td>2019-08-17</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="text-truncate">
                                                                <ul className="list-unstyled order-list m-b-0 m-b-0">
                                                                    <li className="team-member team-member-sm"><img className="rounded-circle" src="assets/img/users/user-7.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                                                                    <li className="team-member team-member-sm"><img className="rounded-circle" src="assets/img/users/user-8.png" alt="user" data-toggle="tooltip" title data-original-title="Sarah Smith" /></li>
                                                                    <li className="avatar avatar-sm"><span className="badge badge-primary">+4</span></li>
                                                                </ul>
                                                            </td>
                                                            <td className="align-middle">
                                                                ...
                                                                <div className="progress" data-height={6}>
                                                                    <div className="progress-bar" data-width="70%" />
                                                                </div>
                                                            </td>
                                                            <td>2018-04-15</td>
                                                            <td>2019-07-19</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="text-truncate">
                                                                <ul className="list-unstyled order-list m-b-0 m-b-0">
                                                                    <li className="team-member team-member-sm"><img className="rounded-circle" src="assets/img/users/user-9.png" alt="user" data-toggle="tooltip" title data-original-title="Wildan Ahdian" /></li>
                                                                    <li className="team-member team-member-sm"><img className="rounded-circle" src="assets/img/users/user-10.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                                                            ...
                                                            <td className="align-middle">
                                                                ...
                                                                <div className="progress" data-height={6}>
                                                                    <div className="progress-bar bg-cyan" data-width="45%" />
                                                                </div>
                                                            </td>
                                                            <td>2017-02-24</td>
                                                            <td>2018-09-06</td>
